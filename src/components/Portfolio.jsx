  ...
  const portfolios = [
    {
      id: 1,
      src: zostel,
      live: "https://zostel-frontend.vercel.app/",
      code: "https://github.com/DenishFuletra/Zostel-Frontend",
      title: "ZOSTEL CLONE",
      description:
    ...
    },
    {
      ...
      description:
        "Bewakoof is India’s largest Casual Wear and Lifestyle Brand and E-commerce platform.",
      techstack: "HTML | CSS | JavaScript",
      members:
        "A collaborative project built by a team of 4 web developers in 6 Days",
      feature1: "User can Sign in & Sign up",
