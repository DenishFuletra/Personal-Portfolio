...
import HeroImage from "../assets/deny.jpg";
    ...
    <div
      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row" style={{ width: "90%", justifyContent:"space-between" }}>
        <div className="flex flex-col justify-center h-full">
          ...
          <div>
            <a href="https://drive.google.com/file/d/1r-IL_oyyy4CiMvRpHnSfBxChaMjRhXt1/view?usp=sharing" target="blank">
            <button
              duration={500}
